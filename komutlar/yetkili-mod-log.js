...
let logkanal = await db.fetch(`codeminglog_${message.guild.id}`)
  ...
  if (args[0] === "sıfırla" || args[0] === "kapat") {
   ...
   message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`<a:evet:1114956255480524910> ModLog Kanalı başarıyla sıfırlandı`).setColor("GREEN"));
...
message.channel.sendEmbed(new Discord.RichEmbed().setDescription(`<a:evet:1114956255480524910> Mod-Log kanalı başarıyla ${logk} olarak ayarlandı`).setColor("GREEN"));
