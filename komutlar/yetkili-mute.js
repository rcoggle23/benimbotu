...
if(!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`**<a:uyar:1114935085406367794> Bu Komutu Kullanmak İçin __Yönetici__ Yetkisine Sahip Olmalısın.**`)
  ...
  message.reply(`<a:evet:1114956255480524910> <@${tomute.id}> Adlı Kişi ${ms(ms(mutetime))} Saniye Kadar Mutelendi!`);

  setTimeout(function(){
    tomute.removeRole(muterole.id);
    message.channel.send(`<a:evet:1114956255480524910> <@${tomute.id}> Adlı Kişinin Mutesi Kalktı!`);
  }, ms(mutetime));
