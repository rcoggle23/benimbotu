...
if(miran === 'aç') {
    ...
    message.reply("<a:evet:1114956255480524910> **Son Üye Kanalı Başarıyla Oluşturuldu.**")
...
if(miran === 'kapat') {
  ...
  let kanals = client.channels.get(db.fetch(`codeming_${message.guild.id}`)) 
    ...
    if(!kanals) {
       message.reply("<a:evet:1114956255480524910> **Son Üye Sistemi Başarıyla Kapatıldı.**")
