...
if (!kanal) {
	...
	message.reply(`<a:evet:1114956255480524910> Önerilerin gönderileceği kanal ${kanal} olarak ayarlandı.`)
} 
  if (args[0] === "sıfırla") {
	db.delete(`onk_${message.guild.id}`)
	message.reply("<a:evet:1114956255480524910> Önerilerin gönderileceği kanal sıfırlandı.")
}
